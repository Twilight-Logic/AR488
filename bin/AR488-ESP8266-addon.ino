// AR488 sketch for add-On WiFi module for the AR488 GPIB-USB adapter 
// Twilight-Logic, (c)15/11/2019

// Note: Requires an ESP8266 NodeMCU board

// AR488 sketch is uploaded to Uno, Nano or Mega
// This sketch is uploaded to the ESP8266
// The ESP8266 must be connected to the AR488 via serial Rx/Tx pins.
