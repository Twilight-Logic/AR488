...
<tr><td>2040</td><td>Raspberry Pico</td><td>Two serial ports. DFU mode.</td><td>A compact board with more GPIO pins and features than UNO or Nano and runs at a much higher clock frequency. However, it runs at 3.3V and may require level shifters and buffer ICs. Two layouts L1 and L2 available.</td></tr>
</table>
