...
/*********************************************/
/***** DEFAULT UNO/NANO LAYOUT FOR 328PB *****/
...
/***** NANO pinout for the 328PB using A0 - A7 *****/
/*
 * Leaves SPI available for peripherals.
 * This is an alternative pinout, similar to the
 * default UNO layout, but which leaves the SPI
 * pins free.
 *
 * The 328PB also has additional I2C pins (I2C1).
 * These pins are available to use, but are not
 * exposed on clone boards. Instead, as with 328P
 * boards, they are connected to VCC and GND.
 * The board should be carefully checked and if
 * that is found to be the case, then these pins
 * must NOT be enabled!
 */
